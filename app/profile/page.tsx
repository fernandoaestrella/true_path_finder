  ...
  return (
    <div className="min-h-screen bg-[var(--background)] pb-20">
      ...
      <main className="container max-w-2xl mx-auto px-4 pt-8 space-y-8">
        ...
        {/* Data Export */}
        <section className="bg-[var(--surface-card)] p-6 rounded-[var(--radius-container)] opacity-80">
          <div className="flex items-center justify-between mb-2">
            <h2 className="text-xl font-semibold text-[var(--text-primary)]">Your Data</h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <button
              disabled={true}
              className="px-4 py-2 rounded-[var(--radius-interactive)] bg-[var(--surface-subtle)] text-[var(--text-muted)] cursor-not-allowed flex items-center justify-center gap-2 opacity-50"
            >
